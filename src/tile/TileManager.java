...
public class TileManager {
    ...
    public void draw(Graphics2D g2) {
        ...
        while(worldCol < gp.maxWorldCol && worldRow < gp.maxWorldRow) {
            ...
            //we create a boundary check to see as long as a tile is inside that boundary we draw it around the player cutting on some extra processing
            boolean boundary = worldX +  gp.tileSize > gp.player.worldX - gp.player.screenX && worldX - gp.tileSize < gp.player.worldX + gp.player.screenX
                    && worldY + gp.tileSize > gp.player.worldY - gp.player.screenY && worldY - gp.tileSize < gp.player.worldY + gp.player.screenY;

            if(boundary) {
                //here what you need to know is what type of tile image you want to draw and where to draw it
